...
viz = [
    ...
    code(BOOT, "",
         ...
         "",
         "cfg = load_config('config.yaml')",
         "con = get_connection(cfg)  # left open; the cells below read worldwide + genre tables",
    ...
    code("ww = con.execute('''SELECT title, release_year, domestic_gross, foreign_gross, worldwide_gross",
         ...
         "))"),
    md("## C. Which genres skew international vs domestic",
    ...
    code("genre = con.execute('''",
         ...
         "    title='Which genres travel? International vs domestic lean',",
         "    subtitle='Top-200 worldwide films, genres with 10+ films. Right = over-indexes internationally.',",
