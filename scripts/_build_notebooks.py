...
viz = [
    ...
    code("# US-made films; top 15 by worldwide gross, ordered by share earned abroad.",
         ...
         "    segments=[{'col':'home_pct','label':'Home (US/Canada)','color':'#EE9B00'},",
